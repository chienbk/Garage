...
public class Constant {
    ...
    public static final String URL__CUSTOMER_ON_MAP = ROOT_URL + "api/v1/gara/customer-on-map/%s";
    public static final String URL_UPDATE_STATE = ROOT_URL + "api/v1/gara/update-state";
    public static final String URL_SEARCH_USER = ROOT_URL + "api/v1/gara/search-user";
    public static final String URL_CREATE_ORDER = ROOT_URL + "api/v1/gara/add-order";
